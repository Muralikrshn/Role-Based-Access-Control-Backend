...
\label{md_node__modules_2mkdirp_2readme_autotoc_md2448}%
\Hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2448}%
...
\normalsize \hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2449}{}\doxysection{\texorpdfstring{example}{example}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2449}
\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2450}{}\doxysubsection{\texorpdfstring{pow.\+js}{pow.\+js}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2450}
...
And now /tmp/foo/bar/baz exists, huzzah!\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2451}{}\doxysection{\texorpdfstring{methods}{methods}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2451}

\begin{DoxyCode}{0}
\DoxyCodeLine{const\ mkdirp\ =\ require('mkdirp')}

\end{DoxyCode}
\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2452}{}\doxysubsection{\texorpdfstring{mkdirp(dir, \mbox{[}opts\mbox{]}) -\/\texorpdfstring{$>$}{>} Promise\texorpdfstring{$<$}{<}String \texorpdfstring{$\vert$}{|} undefined\texorpdfstring{$>$}{>}}{mkdirp(dir, \mbox{[}opts\mbox{]}) -\/\texorpdfstring{$>$}{>} Promise\texorpdfstring{$<$}{<}String \texorpdfstring{$\vert$}{|} undefined\texorpdfstring{$>$}{>}}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2452}
...
You can also override just one or the other of {\ttfamily mkdir} and {\ttfamily stat} by passing in {\ttfamily opts.\+stat} or {\ttfamily opts.\+mkdir}, or providing an {\ttfamily fs} option that only overrides one of these.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2453}{}\doxysubsection{\texorpdfstring{mkdirp.\+sync(dir, opts) -\/\texorpdfstring{$>$}{>} String\texorpdfstring{$\vert$}{|}null}{mkdirp.\+sync(dir, opts) -\/\texorpdfstring{$>$}{>} String\texorpdfstring{$\vert$}{|}null}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2453}
...
You can also override just one or the other of {\ttfamily mkdir\+Sync} and {\ttfamily stat\+Sync} by passing in {\ttfamily opts.\+stat\+Sync} or {\ttfamily opts.\+mkdir\+Sync}, or providing an {\ttfamily fs} option that only overrides one of these.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2454}{}\doxysubsection{\texorpdfstring{mkdirp.\+manual, mkdirp.\+manual\+Sync}{mkdirp.\+manual, mkdirp.\+manual\+Sync}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2454}
Use the manual implementation (not the native one). This is the default when the native implementation is not available or the stat/mkdir implementation is overridden.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2455}{}\doxysubsection{\texorpdfstring{mkdirp.\+native, mkdirp.\+native\+Sync}{mkdirp.\+native, mkdirp.\+native\+Sync}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2455}
Use the native implementation (not the manual one). This is the default when the native implementation is available and stat/mkdir are not overridden.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2456}{}\doxysection{\texorpdfstring{implementation}{implementation}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2456}
On Node.\+js v10.\+12.\+0 and above, use the native {\ttfamily fs.\+mkdir(p, \{recursive\+:true\})} option, unless {\ttfamily fs.\+mkdir}/{\ttfamily fs.\+mkdir\+Sync} has been overridden by an option.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2457}{}\doxysubsection{\texorpdfstring{native implementation}{native implementation}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2457}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2458}{}\doxysubsection{\texorpdfstring{manual implementation}{manual implementation}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2458}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2459}{}\doxysubsection{\texorpdfstring{windows vs unix caveat}{windows vs unix caveat}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2459}
...
In order to work around this issue, the native implementation will fall back to the manual implementation if an {\ttfamily ENOENT} error is encountered.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2461}{}\doxysection{\texorpdfstring{choosing a recursive mkdir implementation}{choosing a recursive mkdir implementation}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2461}
There are a few to choose from! Use the one that suits your needs best \+:D\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2462}{}\doxysubsection{\texorpdfstring{use {\ttfamily fs.\+mkdir(path, \{recursive\+: true\}, cb)} if\+:}{use {\ttfamily fs.\+mkdir(path, \{recursive\+: true\}, cb)} if\+:}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2462}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2463}{}\doxysubsection{\texorpdfstring{use this module (mkdirp 1.\+x) if\+:}{use this module (mkdirp 1.\+x) if\+:}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2463}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2464}{}\doxysubsection{\texorpdfstring{use \href{http://npm.im/make-dir}{\texttt{ {\ttfamily make-\/dir}}} if\+:}{use \href{http://npm.im/make-dir}{\texttt{ {\ttfamily make-\/dir}}} if\+:}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2464}
...
\item You don\textquotesingle{}t need/want a CLI.
\item You need to override the {\ttfamily fs} methods in use.
\end{DoxyItemize}\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2465}{}\doxysubsection{\texorpdfstring{use mkdirp 0.\+x if\+:}{use mkdirp 0.\+x if\+:}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2465}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2466}{}\doxysection{\texorpdfstring{cli}{cli}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2466}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2467}{}\doxysection{\texorpdfstring{install}{install}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2467}
...
to run the command without installing it globally.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2468}{}\doxysection{\texorpdfstring{platform support}{platform support}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2468}
This module works on node v8, but only v10 and above are officially supported, as Node v8 reached its LTS end of life 2020-\/01-\/01, which is in the past, as of this writing.\hypertarget{md_node__modules_2mkdirp_2readme_autotoc_md2469}{}\doxysection{\texorpdfstring{license}{license}}\label{md_node__modules_2mkdirp_2readme_autotoc_md2469}
MIT 