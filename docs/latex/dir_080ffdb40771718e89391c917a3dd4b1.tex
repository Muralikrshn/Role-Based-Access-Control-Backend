...
Get the first event in a set of event emitters and event pairs, then clean up after itself.\hypertarget{README.md_autotoc_md1069}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{README.md_autotoc_md1069}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ ee-\/first}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md1070}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md1070}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ first\ =\ require('ee-\/first')}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md1071}{}\doxysubsubsection{\texorpdfstring{first(arr, listener)}{first(arr, listener)}}\label{README.md_autotoc_md1071}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1072}{}\doxysubsubsubsection{\texorpdfstring{.cancel()}{.cancel()}}\label{README.md_autotoc_md1072}
