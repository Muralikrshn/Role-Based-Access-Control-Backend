\doxysection{node\+\_\+modules/aproba Directory Reference}
\hypertarget{dir_ea47c314f7d13b632039d520a6a01bfe}{}\label{dir_ea47c314f7d13b632039d520a6a01bfe}\index{node\_modules/aproba Directory Reference@{node\_modules/aproba Directory Reference}}
...
\PBS\centering E   &{\ttfamily instanceof Error} OR {\ttfamily null} {\bfseries{(special\+: see below)}}    \\\cline{1-2}
...
To reproduce this you have to fully enumerate all of the possible combinations and that implies a signature of {\ttfamily SO\texorpdfstring{$\vert$}{|}\+SS\texorpdfstring{$\vert$}{|}\+OO\texorpdfstring{$\vert$}{|}\+OS\texorpdfstring{$\vert$}{|}\+S\texorpdfstring{$\vert$}{|}O}. The awkwardness is a feature\+: It reminds you of the complexity you\textquotesingle{}re adding to your API when you do this sort of thing.\hypertarget{README.md_autotoc_md263}{}\doxysubsubsection{\texorpdfstring{Browser support}{Browser support}}\label{README.md_autotoc_md263}
This has no dependencies and should work in browsers, though you\textquotesingle{}ll have noisier stack traces.\hypertarget{README.md_autotoc_md264}{}\doxysubsubsection{\texorpdfstring{Why this exists}{Why this exists}}\label{README.md_autotoc_md264}
