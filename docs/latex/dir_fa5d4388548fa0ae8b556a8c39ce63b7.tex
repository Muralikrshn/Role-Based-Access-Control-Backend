...
\hypertarget{Readme.md_autotoc_md797}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{Readme.md_autotoc_md797}
...
This module can also be bundled with systems like \href{http://browserify.org/}{\texttt{ Browserify}} or \href{https://webpack.github.io/}{\texttt{ webpack}}, though by default this module will alter it\textquotesingle{}s API to no longer display or track deprecations.\hypertarget{Readme.md_autotoc_md798}{}\doxysubsection{\texorpdfstring{API}{API}}\label{Readme.md_autotoc_md798}
...
If the message is omitted, a message is generated for you based on the site of the {\ttfamily deprecate()} call and will display the name of the function called, similar to the name displayed in a stack trace.\hypertarget{Readme.md_autotoc_md801}{}\doxysubsubsection{\texorpdfstring{deprecate.\+function(fn, message)}{deprecate.\+function(fn, message)}}\label{Readme.md_autotoc_md801}
Call this function to wrap a given function in a deprecation message on any call to the function. An optional message can be supplied to provide a custom message.\hypertarget{Readme.md_autotoc_md802}{}\doxysubsubsection{\texorpdfstring{deprecate.\+property(obj, prop, message)}{deprecate.\+property(obj, prop, message)}}\label{Readme.md_autotoc_md802}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md804}{}\doxysubsubsection{\texorpdfstring{process.\+env.\+NO\+\_\+\+DEPRECATION}{process.\+env.\+NO\+\_\+\+DEPRECATION}}\label{Readme.md_autotoc_md804}
...
{\bfseries{NOTE}} This will not suppress the deperecations given to any "{}deprecation"{} event listeners, just the output to STDERR.\hypertarget{Readme.md_autotoc_md805}{}\doxysubsubsection{\texorpdfstring{process.\+env.\+TRACE\+\_\+\+DEPRECATION}{process.\+env.\+TRACE\+\_\+\+DEPRECATION}}\label{Readme.md_autotoc_md805}
...
{\bfseries{NOTE}} This will not trace the deperecations silenced by {\ttfamily NO\+\_\+\+DEPRECATION}.\hypertarget{Readme.md_autotoc_md806}{}\doxysubsection{\texorpdfstring{Display}{Display}}\label{Readme.md_autotoc_md806}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md807}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{Readme.md_autotoc_md807}
\hypertarget{Readme.md_autotoc_md808}{}\doxysubsubsection{\texorpdfstring{Deprecating all calls to a function}{Deprecating all calls to a function}}\label{Readme.md_autotoc_md808}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md809}{}\doxysubsubsection{\texorpdfstring{Conditionally deprecating a function call}{Conditionally deprecating a function call}}\label{Readme.md_autotoc_md809}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md810}{}\doxysubsubsection{\texorpdfstring{Deprecating property access}{Deprecating property access}}\label{Readme.md_autotoc_md810}
...
\end{DoxyCode}
\hypertarget{Readme.md_autotoc_md811}{}\doxysubsection{\texorpdfstring{License}{License}}\label{Readme.md_autotoc_md811}
