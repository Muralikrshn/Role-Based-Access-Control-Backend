...
Encode a URL to a percent-\/encoded form, excluding already-\/encoded sequences.\hypertarget{README.md_autotoc_md1078}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md1078}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1080}{}\doxysubsubsection{\texorpdfstring{encode\+Url(url)}{encode\+Url(url)}}\label{README.md_autotoc_md1080}
...
This encode is meant to be "{}safe"{} and does not throw errors. It will try as hard as it can to properly encode the given URL, including replacing any raw, unpaired surrogate pairs with the Unicode replacement character prior to encoding.\hypertarget{README.md_autotoc_md1081}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{README.md_autotoc_md1081}
\hypertarget{README.md_autotoc_md1082}{}\doxysubsubsection{\texorpdfstring{Encode a URL containing user-\/controlled data}{Encode a URL containing user-\/controlled data}}\label{README.md_autotoc_md1082}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1083}{}\doxysubsubsection{\texorpdfstring{Encode a URL for use in a header field}{Encode a URL for use in a header field}}\label{README.md_autotoc_md1083}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1084}{}\doxysubsection{\texorpdfstring{Similarities}{Similarities}}\label{README.md_autotoc_md1084}
...
It is expected that any output from {\ttfamily new URL(url)} will not change when used with this package, as the output has already been encoded. Additionally, if we were to encode before {\ttfamily new URL(url)}, we do not expect the before and after encoded formats to be parsed any differently.\hypertarget{README.md_autotoc_md1085}{}\doxysubsection{\texorpdfstring{Testing}{Testing}}\label{README.md_autotoc_md1085}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1086}{}\doxysubsection{\texorpdfstring{References}{References}}\label{README.md_autotoc_md1086}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1087}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md1087}
