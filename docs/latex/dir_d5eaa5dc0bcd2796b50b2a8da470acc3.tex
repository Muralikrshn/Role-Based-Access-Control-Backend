...
The async versions work much like their node builtin counterparts, with the exception of introducing significantly less Stream machinery overhead.\hypertarget{README.md_autotoc_md1579}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{README.md_autotoc_md1579}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1580}{}\doxysubsection{\texorpdfstring{Read\+Stream(path, options)}{Read\+Stream(path, options)}}\label{README.md_autotoc_md1580}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1581}{}\doxysubsection{\texorpdfstring{Write\+Stream(path, options)}{Write\+Stream(path, options)}}\label{README.md_autotoc_md1581}
Path string is required, but somewhat irrelevant if an open file descriptor is passed in as an option.
