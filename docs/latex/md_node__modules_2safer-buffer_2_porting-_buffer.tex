...
\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3514}%
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3514}%
...
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_overview}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3515}{}\doxysection{\texorpdfstring{Overview}{Overview}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3515}
...
\end{DoxyItemize}\hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3516}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using grep}{Finding problematic bits of code using grep}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3516}
...
It will find all the potentially unsafe places in your own code (with some considerably unlikely exceptions).\hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3517}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using Node.\+js 8}{Finding problematic bits of code using Node.\+js 8}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3517}
...
\end{DoxyCode}
\hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3518}{}\doxysubsection{\texorpdfstring{Finding problematic bits of code using linters}{Finding problematic bits of code using linters}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3518}
...
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_variant-1}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3519}{}\doxysection{\texorpdfstring{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3519}
...
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_variant-2}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3520}{}\doxysection{\texorpdfstring{Variant 2\+: Use a polyfill}{Variant 2\+: Use a polyfill}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3520}
...
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_variant-3}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3521}{}\doxysection{\texorpdfstring{Variant 3 — manual detection, with safeguards}{Variant 3 — manual detection, with safeguards}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3521}
This is useful if you create Buffer instances in only a few places (e.\+g. one), or you have your own wrapper around them.\hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3522}{}\doxysubsection{\texorpdfstring{Buffer(0)}{Buffer(0)}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3522}
This special case for creating empty buffers can be safely replaced with {\ttfamily Buffer.\+concat(\mbox{[}$\,$\mbox{]})}, which returns the same result all the way down to Node.\+js 0.\+8.\+x.\hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3523}{}\doxysubsection{\texorpdfstring{Buffer(not\+Number)}{Buffer(not\+Number)}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3523}
Before\+:
...
\end{DoxyCode}
\hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3525}{}\doxysection{\texorpdfstring{Regarding Buffer.\+alloc\+Unsafe}{Regarding Buffer.\+alloc\+Unsafe}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3525}
...
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_faq}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3526}{}\doxysection{\texorpdfstring{FAQ}{FAQ}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3526}
...
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_design-flaws}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3527}{}\doxysubsection{\texorpdfstring{What is wrong with the {\ttfamily Buffer} constructor?}{What is wrong with the {\ttfamily Buffer} constructor?}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3527}
...
\Hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_ecosystem-usage}%
 \hypertarget{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3528}{}\doxysubsection{\texorpdfstring{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}{The {\ttfamily Buffer()} constructor has been deprecated for a while. Is this really an issue?}}\label{md_node__modules_2safer-buffer_2_porting-_buffer_autotoc_md3528}
