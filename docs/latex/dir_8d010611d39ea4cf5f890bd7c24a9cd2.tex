...
\item 
directory \mbox{\hyperlink{dir_0c1470243f3092a609a14dacbc877dc7}{bin}}
\item 
directory \mbox{\hyperlink{dir_a9f46c651329192d6bb84991e9f601e0}{lib}}
...
Read the tests at the bottom of {\ttfamily lib/nopt.\+js} for more examples of what this puppy can do.\hypertarget{README.md_autotoc_md2891}{}\doxysubsubsection{\texorpdfstring{Types}{Types}}\label{README.md_autotoc_md2891}
...
You can also call {\ttfamily nopt.\+clean(data, types, type\+Defs)} to clean up a config object and remove its invalid properties.\hypertarget{README.md_autotoc_md2892}{}\doxysubsubsection{\texorpdfstring{Error Handling}{Error Handling}}\label{README.md_autotoc_md2892}
...
If no {\ttfamily nopt.\+invalid\+Handler} is assigned, then it will console.\+error its whining. If it is assigned to boolean {\ttfamily false} then the warning is suppressed.\hypertarget{README.md_autotoc_md2893}{}\doxysubsubsection{\texorpdfstring{Abbreviations}{Abbreviations}}\label{README.md_autotoc_md2893}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md2894}{}\doxysubsubsection{\texorpdfstring{Shorthands}{Shorthands}}\label{README.md_autotoc_md2894}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md2895}{}\doxysubsubsection{\texorpdfstring{The Rest of the args}{The Rest of the args}}\label{README.md_autotoc_md2895}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md2896}{}\doxysubsubsection{\texorpdfstring{Slicing}{Slicing}}\label{README.md_autotoc_md2896}
