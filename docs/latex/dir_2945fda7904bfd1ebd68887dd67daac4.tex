\doxysection{node\+\_\+modules/are-\/we-\/there-\/yet Directory Reference}
\hypertarget{dir_2945fda7904bfd1ebd68887dd67daac4}{}\label{dir_2945fda7904bfd1ebd68887dd67daac4}\index{node\_modules/are-\/we-\/there-\/yet Directory Reference@{node\_modules/are-\/we-\/there-\/yet Directory Reference}}
\doxysubsubsection*{Directories}
\begin{DoxyCompactItemize}
\item 
directory \mbox{\hyperlink{dir_23b384c8ca50b9302db7d0bbce5cc2e6}{lib}}
...
Most progress bar modules include a rudimentary version of this, but my needs were more complex.\hypertarget{README.md_autotoc_md265}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md265}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md266}{}\doxysubsection{\texorpdfstring{Shared Methods}{Shared Methods}}\label{README.md_autotoc_md266}
...
This will result in one or more {\ttfamily change} events being emitted.\hypertarget{README.md_autotoc_md267}{}\doxysubsection{\texorpdfstring{Events}{Events}}\label{README.md_autotoc_md267}
...
{\ttfamily tracker} is the tracker object that you are listening for events on.\hypertarget{README.md_autotoc_md268}{}\doxysubsection{\texorpdfstring{Tracker\+Group}{Tracker\+Group}}\label{README.md_autotoc_md268}

\begin{DoxyItemize}
\item var tracker = new Tracker\+Group({\bfseries{name}})
\begin{DoxyItemize}
\item {\bfseries{name}} {\itshape (optional)} -\/ The name of this tracker group, used in change notifications if the component updating didn\textquotesingle{}t have a name. Defaults to undefined.
\end{DoxyItemize}
\end{DoxyItemize}
...
\item {\bfseries{weight}} {\itshape (optional)} -\/ The weight to give the tracker, defaults to 1.
\end{DoxyItemize}
\end{DoxyItemize}
...
Returns a tree showing the completion of this tracker group and all of its children, including recursively entering all of the children.\hypertarget{README.md_autotoc_md269}{}\doxysubsection{\texorpdfstring{Tracker}{Tracker}}\label{README.md_autotoc_md269}

\begin{DoxyItemize}
\item var tracker = new Tracker({\bfseries{name}}, {\bfseries{todo}})
\begin{DoxyItemize}
\item {\bfseries{name}} {\itshape (optional)} The name of this counter to report in change events. Defaults to undefined.
\item {\bfseries{todo}} {\itshape (optional)} The amount of work todo (a number). Defaults to 0.
\end{DoxyItemize}
\end{DoxyItemize}
...
Marks this tracker as finished, tracker.\+completed() will now be 1. Triggers a {\ttfamily change} event.\hypertarget{README.md_autotoc_md270}{}\doxysubsection{\texorpdfstring{Tracker\+Stream}{Tracker\+Stream}}\label{README.md_autotoc_md270}

\begin{DoxyItemize}
\item var tracker = new Tracker\+Stream({\bfseries{name}}, {\bfseries{size}}, {\bfseries{options}})
\begin{DoxyItemize}
\item {\bfseries{name}} {\itshape (optional)} The name of this counter to report in change events. Defaults to undefined.
\item {\bfseries{size}} {\itshape (optional)} The number of bytes being sent through this stream.
\item {\bfseries{options}} {\itshape (optional)} A hash of stream options
\end{DoxyItemize}
\end{DoxyItemize}
