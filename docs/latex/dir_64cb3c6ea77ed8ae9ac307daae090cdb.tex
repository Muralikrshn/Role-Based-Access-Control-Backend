...
Basic HTTP cookie parser and serializer for HTTP servers.\hypertarget{README.md_autotoc_md717}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md717}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md718}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md718}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ cookie\ =\ require('cookie');}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md719}{}\doxysubsubsection{\texorpdfstring{cookie.\+parse(str, options)}{cookie.\+parse(str, options)}}\label{README.md_autotoc_md719}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md720}{}\doxysubsubsubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md720}
{\ttfamily cookie.\+parse} accepts these properties in the options object.\hypertarget{README.md_autotoc_md721}{}\doxysubsubsubsubsection{\texorpdfstring{decode}{decode}}\label{README.md_autotoc_md721}
...
{\bfseries{note}} if an error is thrown from this function, the original, non-\/decoded cookie value will be returned as the cookie\textquotesingle{}s value.\hypertarget{README.md_autotoc_md722}{}\doxysubsubsection{\texorpdfstring{cookie.\+serialize(name, value, options)}{cookie.\+serialize(name, value, options)}}\label{README.md_autotoc_md722}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md723}{}\doxysubsubsubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md723}
{\ttfamily cookie.\+serialize} accepts these properties in the options object.\hypertarget{README.md_autotoc_md724}{}\doxysubsubsubsubsection{\texorpdfstring{domain}{domain}}\label{README.md_autotoc_md724}
Specifies the value for the \href{https://tools.ietf.org/html/rfc6265\#section-5.2.3}{\texttt{ {\ttfamily Domain} {\ttfamily Set-\/\+Cookie} attribute}}. By default, no domain is set, and most clients will consider the cookie to apply to only the current domain.\hypertarget{README.md_autotoc_md725}{}\doxysubsubsubsubsection{\texorpdfstring{encode}{encode}}\label{README.md_autotoc_md725}
...
The default function is the global {\ttfamily encode\+URIComponent}, which will encode a Java\+Script string into UTF-\/8 byte sequences and then URL-\/encode any that fall outside of the cookie range.\hypertarget{README.md_autotoc_md726}{}\doxysubsubsubsubsection{\texorpdfstring{expires}{expires}}\label{README.md_autotoc_md726}
...
{\bfseries{note}} be careful when setting this to {\ttfamily true}, as compliant clients will not allow client-\/side Java\+Script to see the cookie in {\ttfamily document.\+cookie}.\hypertarget{README.md_autotoc_md728}{}\doxysubsubsubsubsection{\texorpdfstring{max\+Age}{max\+Age}}\label{README.md_autotoc_md728}
...
{\bfseries{note}} the \href{https://tools.ietf.org/html/rfc6265\#section-5.3}{\texttt{ cookie storage model specification}} states that if both {\ttfamily expires} and {\ttfamily max\+Age} are set, then {\ttfamily max\+Age} takes precedence, but it is possible not all clients by obey this, so if both are set, they should point to the same date and time.\hypertarget{README.md_autotoc_md729}{}\doxysubsubsubsubsection{\texorpdfstring{partitioned}{partitioned}}\label{README.md_autotoc_md729}
...
More information about can be found in \href{https://github.com/privacycg/CHIPS}{\texttt{ the proposal}}.\hypertarget{README.md_autotoc_md730}{}\doxysubsubsubsubsection{\texorpdfstring{path}{path}}\label{README.md_autotoc_md730}
Specifies the value for the \href{https://tools.ietf.org/html/rfc6265\#section-5.2.4}{\texttt{ {\ttfamily Path} {\ttfamily Set-\/\+Cookie} attribute}}. By default, the path is considered the \href{https://tools.ietf.org/html/rfc6265\#section-5.1.4}{\texttt{ "{}default path"{}}}.\hypertarget{README.md_autotoc_md731}{}\doxysubsubsubsubsection{\texorpdfstring{priority}{priority}}\label{README.md_autotoc_md731}
...
{\bfseries{note}} This is an attribute that has not yet been fully standardized, and may change in the future. This also means many clients may ignore this attribute until they understand it.\hypertarget{README.md_autotoc_md732}{}\doxysubsubsubsubsection{\texorpdfstring{same\+Site}{same\+Site}}\label{README.md_autotoc_md732}
...
{\bfseries{note}} This is an attribute that has not yet been fully standardized, and may change in the future. This also means many clients may ignore this attribute until they understand it.\hypertarget{README.md_autotoc_md733}{}\doxysubsubsubsubsection{\texorpdfstring{secure}{secure}}\label{README.md_autotoc_md733}
...
{\bfseries{note}} be careful when setting this to {\ttfamily true}, as compliant clients will not send the cookie back to the server in the future if the browser does not have an HTTPS connection.\hypertarget{README.md_autotoc_md734}{}\doxysubsection{\texorpdfstring{Example}{Example}}\label{README.md_autotoc_md734}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md735}{}\doxysubsection{\texorpdfstring{Testing}{Testing}}\label{README.md_autotoc_md735}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md736}{}\doxysubsection{\texorpdfstring{Benchmark}{Benchmark}}\label{README.md_autotoc_md736}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md737}{}\doxysubsection{\texorpdfstring{References}{References}}\label{README.md_autotoc_md737}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md738}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md738}
