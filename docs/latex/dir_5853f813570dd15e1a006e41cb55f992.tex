...
Determine address of proxied request\hypertarget{README.md_autotoc_md3200}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{README.md_autotoc_md3200}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md3202}{}\doxysubsubsection{\texorpdfstring{proxyaddr(req, trust)}{proxyaddr(req, trust)}}\label{README.md_autotoc_md3202}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md3204}{}\doxysubsubsection{\texorpdfstring{proxyaddr.\+compile(val)}{proxyaddr.\+compile(val)}}\label{README.md_autotoc_md3204}
...
This function is meant to be optimized for use against every request. It is recommend to compile a trust function up-\/front for the trusted configuration and pass that to {\ttfamily proxyaddr(req, trust)} for each request.\hypertarget{README.md_autotoc_md3205}{}\doxysubsection{\texorpdfstring{Testing}{Testing}}\label{README.md_autotoc_md3205}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md3206}{}\doxysubsection{\texorpdfstring{Benchmarks}{Benchmarks}}\label{README.md_autotoc_md3206}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ run-\/script\ bench}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md3207}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md3207}
