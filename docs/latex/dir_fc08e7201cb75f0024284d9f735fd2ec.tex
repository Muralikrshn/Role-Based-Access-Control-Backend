...
\item 
directory \mbox{\hyperlink{dir_d3e362dd84740c70c26b85075a05546e}{lib}}
\end{DoxyCompactItemize}


\doxysubsection{Detailed Description}
\hypertarget{README.md_autotoc_md110}{}\doxysubsubsubsection{\texorpdfstring{@mapbox/node-\/pre-\/gyp makes it easy to publish and install Node.\+js C++ addons from binaries}{@mapbox/node-\/pre-\/gyp makes it easy to publish and install Node.\+js C++ addons from binaries}}\label{README.md_autotoc_md110}
\href{https://travis-ci.com/mapbox/node-pre-gyp}{\texttt{ }} \href{https://ci.appveyor.com/project/Mapbox/node-pre-gyp}{\texttt{ }}

{\ttfamily @mapbox/node-\/pre-\/gyp} stands between \href{https://github.com/npm/npm}{\texttt{ npm}} and \href{https://github.com/Tootallnate/node-gyp}{\texttt{ node-\/gyp}} and offers a cross-\/platform method of binary deployment.\hypertarget{README.md_autotoc_md111}{}\doxysubsubsection{\texorpdfstring{Special note on previous package}{Special note on previous package}}\label{README.md_autotoc_md111}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md112}{}\doxysubsubsection{\texorpdfstring{Features}{Features}}\label{README.md_autotoc_md112}
...
For a hello world example of a module packaged with {\ttfamily node-\/pre-\/gyp} see \href{https://github.com/springmeyer/node-addon-example}{\texttt{ https\+://github.\+com/springmeyer/node-\/addon-\/example}} and \href{https://github.com/mapbox/node-pre-gyp/wiki/Modules-using-node-pre-gyp}{\texttt{ the wiki}} for real world examples.\hypertarget{README.md_autotoc_md113}{}\doxysubsection{\texorpdfstring{Credits}{Credits}}\label{README.md_autotoc_md113}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md114}{}\doxysubsection{\texorpdfstring{FAQ}{FAQ}}\label{README.md_autotoc_md114}
See the \href{https://github.com/mapbox/node-pre-gyp/wiki/FAQ}{\texttt{ Frequently Ask Questions}}.\hypertarget{README.md_autotoc_md115}{}\doxysubsection{\texorpdfstring{Depends}{Depends}}\label{README.md_autotoc_md115}

\begin{DoxyItemize}
\item Node.\+js \texorpdfstring{$>$}{>}= node v8.\+x
\end{DoxyItemize}\hypertarget{README.md_autotoc_md116}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{README.md_autotoc_md116}
...
\end{DoxyVerb}
\hypertarget{README.md_autotoc_md117}{}\doxysubsection{\texorpdfstring{Usage}{Usage}}\label{README.md_autotoc_md117}
\hypertarget{README.md_autotoc_md118}{}\doxysubsubsection{\texorpdfstring{Commands}{Commands}}\label{README.md_autotoc_md118}
...
\end{DoxyVerb}
\hypertarget{README.md_autotoc_md119}{}\doxysubsubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md119}
Options include\+:
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md120}{}\doxysubsubsection{\texorpdfstring{Configuring}{Configuring}}\label{README.md_autotoc_md120}
This is a guide to configuring your module to use node-\/pre-\/gyp.\hypertarget{README.md_autotoc_md121}{}\doxysubsubsubsection{\texorpdfstring{1) Add new entries to your {\ttfamily package.\+json}}{1) Add new entries to your {\ttfamily package.\+json}}}\label{README.md_autotoc_md121}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md124}{}\doxysubsubsubsubsubsection{\texorpdfstring{module\+\_\+path}{module\+\_\+path}}\label{README.md_autotoc_md124}
The location your native module is placed after a build. This should be an empty directory without other Javascript files. This entire directory will be packaged in the binary tarball. When installing from a remote package this directory will be overwritten with the contents of the tarball.

Note\+: This property supports variables based on Versioning.\hypertarget{README.md_autotoc_md125}{}\doxysubsubsubsubsubsection{\texorpdfstring{host}{host}}\label{README.md_autotoc_md125}
...
It should also be mentioned that there is an optional and entirely separate npm module called \href{https://github.com/bchr02/node-pre-gyp-github}{\texttt{ node-\/pre-\/gyp-\/github}} which is intended to complement node-\/pre-\/gyp and be installed along with it. It provides the ability to store and publish your binaries within your repositories Git\+Hub Releases if you would rather not use S3 directly. Installation and usage instructions can be found \href{https://github.com/bchr02/node-pre-gyp-github}{\texttt{ here}}, but the basic premise is that instead of using the {\ttfamily node-\/pre-\/gyp publish} command you would use {\ttfamily node-\/pre-\/gyp-\/github publish}.\hypertarget{README.md_autotoc_md126}{}\doxysubsubsubsubsection{\texorpdfstring{The {\ttfamily binary} object other optional S3 properties}{The {\ttfamily binary} object other optional S3 properties}}\label{README.md_autotoc_md126}
If you are not using a standard s3 path like {\ttfamily bucket\+\_\+name.\+s3(.-\/)region.\+amazonaws.\+com}, you might get an error on {\ttfamily publish} because node-\/pre-\/gyp extracts the region and bucket from the {\ttfamily host} url. For example, you may have an on-\/premises s3-\/compatible storage server, or may have configured a specific dns redirecting to an s3 endpoint. In these cases, you can explicitly set the {\ttfamily region} and {\ttfamily bucket} properties to tell node-\/pre-\/gyp to use these values instead of guessing from the {\ttfamily host} property. The following values can be used in the {\ttfamily binary} section\+:\hypertarget{README.md_autotoc_md127}{}\doxysubsubsubsubsubsection{\texorpdfstring{host}{host}}\label{README.md_autotoc_md127}
The url to the remote server root location (must be {\ttfamily https} not {\ttfamily http}).\hypertarget{README.md_autotoc_md128}{}\doxysubsubsubsubsubsection{\texorpdfstring{bucket}{bucket}}\label{README.md_autotoc_md128}
The bucket name where your tarball binaries should be located.\hypertarget{README.md_autotoc_md129}{}\doxysubsubsubsubsubsection{\texorpdfstring{region}{region}}\label{README.md_autotoc_md129}
Your S3 server region.\hypertarget{README.md_autotoc_md130}{}\doxysubsubsubsubsubsection{\texorpdfstring{s3\+Force\+Path\+Style}{s3\+Force\+Path\+Style}}\label{README.md_autotoc_md130}
Set {\ttfamily s3\+Force\+Path\+Style} to true if the endpoint url should not be prefixed with the bucket name. If false (default), the server endpoint would be constructed as {\ttfamily bucket\+\_\+name.\+your\+\_\+server.\+com}.\hypertarget{README.md_autotoc_md131}{}\doxysubsubsubsubsection{\texorpdfstring{The {\ttfamily binary} object has optional properties}{The {\ttfamily binary} object has optional properties}}\label{README.md_autotoc_md131}
\hypertarget{README.md_autotoc_md132}{}\doxysubsubsubsubsubsection{\texorpdfstring{remote\+\_\+path}{remote\+\_\+path}}\label{README.md_autotoc_md132}
...
Note\+: This property supports variables based on Versioning.\hypertarget{README.md_autotoc_md133}{}\doxysubsubsubsubsubsection{\texorpdfstring{package\+\_\+name}{package\+\_\+name}}\label{README.md_autotoc_md133}
...
Note\+: This property supports variables based on Versioning.\hypertarget{README.md_autotoc_md134}{}\doxysubsubsubsection{\texorpdfstring{2) Add a new target to binding.\+gyp}{2) Add a new target to binding.\+gyp}}\label{README.md_autotoc_md134}
...
For a full example see \href{https://github.com/springmeyer/node-addon-example/blob/2ff60a8ded7f042864ad21db00c3a5a06cf47075/binding.gyp}{\texttt{ node-\/addon-\/example\textquotesingle{}s binding.\+gyp}}.\hypertarget{README.md_autotoc_md135}{}\doxysubsubsubsection{\texorpdfstring{3) Dynamically require your {\ttfamily .node}}{3) Dynamically require your {\ttfamily .node}}}\label{README.md_autotoc_md135}
...
For a full example see \href{https://github.com/springmeyer/node-addon-example/blob/2ff60a8ded7f042864ad21db00c3a5a06cf47075/index.js\#L1-L4}{\texttt{ node-\/addon-\/example\textquotesingle{}s index.\+js}}\hypertarget{README.md_autotoc_md136}{}\doxysubsubsubsection{\texorpdfstring{4) Build and package your app}{4) Build and package your app}}\label{README.md_autotoc_md136}
...
Now {\ttfamily node-\/pre-\/gyp} should now also be installed as a local dependency so the command line tool it offers can be found at {\ttfamily ./node\+\_\+modules/.bin/node-\/pre-\/gyp}.\hypertarget{README.md_autotoc_md137}{}\doxysubsubsubsection{\texorpdfstring{5) Test}{5) Test}}\label{README.md_autotoc_md137}
Now {\ttfamily npm test} should work just as it did before.\hypertarget{README.md_autotoc_md138}{}\doxysubsubsubsection{\texorpdfstring{6) Publish the tarball}{6) Publish the tarball}}\label{README.md_autotoc_md138}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md139}{}\doxysubsubsubsection{\texorpdfstring{7) Automate builds}{7) Automate builds}}\label{README.md_autotoc_md139}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md140}{}\doxysubsubsubsection{\texorpdfstring{8) You\textquotesingle{}re done!}{8) You\textquotesingle{}re done!}}\label{README.md_autotoc_md140}
...
If a a binary was not available for a given platform and {\ttfamily -\/-\/fallback-\/to-\/build} was used then {\ttfamily node-\/gyp rebuild} will be called to try to source compile the module.\hypertarget{README.md_autotoc_md141}{}\doxysubsubsubsection{\texorpdfstring{9) One more option}{9) One more option}}\label{README.md_autotoc_md141}
...
This allows installing from staging by specifying {\ttfamily -\/-\/s3\+\_\+host=staging}. And it requires specifying {\ttfamily -\/-\/s3\+\_\+option=production} in order to publish to, or unpublish from, production, making accidental errors less likely.\hypertarget{README.md_autotoc_md142}{}\doxysubsection{\texorpdfstring{Node-\/\+API Considerations}{Node-\/\+API Considerations}}\label{README.md_autotoc_md142}
...
The most significant difference is that an Node-\/\+API module can be coded to target multiple Node-\/\+API versions. Therefore, an Node-\/\+API module must declare in its {\ttfamily package.\+json} file which Node-\/\+API versions the module is designed to run against. In addition, since multiple builds may be required for a single module, path and file names must be specified in way that avoids naming conflicts.\hypertarget{README.md_autotoc_md143}{}\doxysubsubsection{\texorpdfstring{The {\ttfamily napi\+\_\+versions} array property}{The {\ttfamily napi\+\_\+versions} array property}}\label{README.md_autotoc_md143}
...
When the {\ttfamily napi\+\_\+versions} array property is present, {\ttfamily node-\/pre-\/gyp} fires off multiple operations, one for each of the Node-\/\+API versions in the array. In the example above, two operations are initiated, one for Node-\/\+API version 1 and second for Node-\/\+API version 3. How this version number is communicated is described next.\hypertarget{README.md_autotoc_md144}{}\doxysubsubsection{\texorpdfstring{The {\ttfamily napi\+\_\+build\+\_\+version} value}{The {\ttfamily napi\+\_\+build\+\_\+version} value}}\label{README.md_autotoc_md144}
...
\end{DoxyEnumerate}\hypertarget{README.md_autotoc_md145}{}\doxysubsubsection{\texorpdfstring{Defining {\ttfamily NAPI\+\_\+\+VERSION} for the C/\+C++ code}{Defining {\ttfamily NAPI\+\_\+\+VERSION} for the C/\+C++ code}}\label{README.md_autotoc_md145}
...
\hypertarget{README.md_autotoc_md146}{}\doxysubsubsection{\texorpdfstring{Path and file naming requirements in {\ttfamily package.\+json}}{Path and file naming requirements in {\ttfamily package.\+json}}}\label{README.md_autotoc_md146}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md147}{}\doxysubsection{\texorpdfstring{Supporting both Node-\/\+API and NAN builds}{Supporting both Node-\/\+API and NAN builds}}\label{README.md_autotoc_md147}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md148}{}\doxysubsubsection{\texorpdfstring{Two additional configuration values}{Two additional configuration values}}\label{README.md_autotoc_md148}
...
These values are present for use in the {\ttfamily binding.\+gyp} file and may be used as {\ttfamily \{napi\+\_\+version\}} and {\ttfamily \{node\+\_\+abi\+\_\+napi\}} for text substituion in the {\ttfamily binary} properties of the {\ttfamily package.\+json} file.\hypertarget{README.md_autotoc_md149}{}\doxysubsection{\texorpdfstring{S3 Hosting}{S3 Hosting}}\label{README.md_autotoc_md149}
...
First, get setup locally and test the workflow\+:\hypertarget{README.md_autotoc_md150}{}\doxysubsubsubsection{\texorpdfstring{1) Create an S3 bucket}{1) Create an S3 bucket}}\label{README.md_autotoc_md150}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md151}{}\doxysubsubsubsection{\texorpdfstring{2) Install node-\/pre-\/gyp}{2) Install node-\/pre-\/gyp}}\label{README.md_autotoc_md151}
...
\end{DoxyVerb}
\hypertarget{README.md_autotoc_md152}{}\doxysubsubsubsection{\texorpdfstring{3) Configure AWS credentials}{3) Configure AWS credentials}}\label{README.md_autotoc_md152}
...
But also you can also use the {\ttfamily Shared Config File} mentioned \href{https://docs.aws.amazon.com/sdk-for-javascript/v2/developer-guide/configuring-the-jssdk.html}{\texttt{ in the AWS JS SDK v2 docs}}\hypertarget{README.md_autotoc_md153}{}\doxysubsubsubsection{\texorpdfstring{4) Package and publish your build}{4) Package and publish your build}}\label{README.md_autotoc_md153}
...
Note\+: if you hit an error like {\ttfamily Hostname/\+IP doesn\textquotesingle{}t match certificate\textquotesingle{}s altnames} it may mean that you need to provide the {\ttfamily region} option in your config.\hypertarget{README.md_autotoc_md154}{}\doxysubsection{\texorpdfstring{Appveyor Automation}{Appveyor Automation}}\label{README.md_autotoc_md154}
...
Below is a guide to getting set up\+:\hypertarget{README.md_autotoc_md155}{}\doxysubsubsubsection{\texorpdfstring{1) Create a free Appveyor account}{1) Create a free Appveyor account}}\label{README.md_autotoc_md155}
Go to \href{https://ci.appveyor.com/signup/free}{\texttt{ https\+://ci.\+appveyor.\+com/signup/free}} and sign in with your Git\+Hub account.\hypertarget{README.md_autotoc_md156}{}\doxysubsubsubsection{\texorpdfstring{2) Create a new project}{2) Create a new project}}\label{README.md_autotoc_md156}
Go to \href{https://ci.appveyor.com/projects/new}{\texttt{ https\+://ci.\+appveyor.\+com/projects/new}} and select the Git\+Hub repo for your module\hypertarget{README.md_autotoc_md157}{}\doxysubsubsubsection{\texorpdfstring{3) Add appveyor.\+yml and push it}{3) Add appveyor.\+yml and push it}}\label{README.md_autotoc_md157}
Once you have committed an {\ttfamily appveyor.\+yml} (\href{http://www.appveyor.com/docs/appveyor-yml}{\texttt{ appveyor.\+yml reference}}) to your Git\+Hub repo and pushed it App\+Veyor should automatically start building your project.\hypertarget{README.md_autotoc_md158}{}\doxysubsubsubsection{\texorpdfstring{4) Create secure variables}{4) Create secure variables}}\label{README.md_autotoc_md158}
...
NOTE\+: keys are per account but not per repo (this is difference than Travis where keys are per repo but not related to the account used to encrypt them).\hypertarget{README.md_autotoc_md159}{}\doxysubsubsubsection{\texorpdfstring{5) Hook up publishing}{5) Hook up publishing}}\label{README.md_autotoc_md159}
Just put {\ttfamily node-\/pre-\/gyp package publish} in your {\ttfamily appveyor.\+yml} after {\ttfamily npm install}.\hypertarget{README.md_autotoc_md160}{}\doxysubsubsubsection{\texorpdfstring{6) Publish when you want}{6) Publish when you want}}\label{README.md_autotoc_md160}
...
Remember this publishing is not the same as {\ttfamily npm publish}. We\textquotesingle{}re just talking about the binary module here and not your entire npm package.\hypertarget{README.md_autotoc_md161}{}\doxysubsection{\texorpdfstring{Travis Automation}{Travis Automation}}\label{README.md_autotoc_md161}
...
Below is a guide to getting set up\+:\hypertarget{README.md_autotoc_md162}{}\doxysubsubsubsection{\texorpdfstring{1) Install the Travis gem}{1) Install the Travis gem}}\label{README.md_autotoc_md162}
\begin{DoxyVerb}gem install travis
\end{DoxyVerb}
\hypertarget{README.md_autotoc_md163}{}\doxysubsubsubsection{\texorpdfstring{2) Create secure variables}{2) Create secure variables}}\label{README.md_autotoc_md163}
...
More details on Travis encryption at \href{http://about.travis-ci.org/docs/user/encryption-keys/}{\texttt{ http\+://about.\+travis-\/ci.\+org/docs/user/encryption-\/keys/}}.\hypertarget{README.md_autotoc_md164}{}\doxysubsubsubsection{\texorpdfstring{3) Hook up publishing}{3) Hook up publishing}}\label{README.md_autotoc_md164}
Just put {\ttfamily node-\/pre-\/gyp package publish} in your {\ttfamily .travis.\+yml} after {\ttfamily npm install}.\hypertarget{README.md_autotoc_md165}{}\doxysubsubsubsubsection{\texorpdfstring{OS X publishing}{OS X publishing}}\label{README.md_autotoc_md165}
...
For detailed multi-\/\+OS examples see \href{https://github.com/mapnik/node-mapnik/blob/master/.travis.yml}{\texttt{ node-\/mapnik}} and \href{https://github.com/mapbox/node-sqlite3/blob/master/.travis.yml}{\texttt{ node-\/sqlite3}}.\hypertarget{README.md_autotoc_md166}{}\doxysubsubsubsubsection{\texorpdfstring{Travis OS X Gotchas}{Travis OS X Gotchas}}\label{README.md_autotoc_md166}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md167}{}\doxysubsubsubsection{\texorpdfstring{4) Publish when you want}{4) Publish when you want}}\label{README.md_autotoc_md167}
...
Remember this publishing is not the same as {\ttfamily npm publish}. We\textquotesingle{}re just talking about the binary module here and not your entire npm package. To automate the publishing of your entire package to npm on Travis see \href{http://about.travis-ci.org/docs/user/deployment/npm/}{\texttt{ http\+://about.\+travis-\/ci.\+org/docs/user/deployment/npm/}}\hypertarget{README.md_autotoc_md168}{}\doxysubsection{\texorpdfstring{Versioning}{Versioning}}\label{README.md_autotoc_md168}
