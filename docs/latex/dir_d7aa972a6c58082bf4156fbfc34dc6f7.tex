...
Modern Buffer API polyfill without footguns, working on Node.\+js from 0.\+8 to current.\hypertarget{Readme.md_autotoc_md3530}{}\doxysubsection{\texorpdfstring{How to use?}{How to use?}}\label{Readme.md_autotoc_md3530}
...
Also, see the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting Buffer}} guide.\hypertarget{Readme.md_autotoc_md3531}{}\doxysubsection{\texorpdfstring{Do I need it?}{Do I need it?}}\label{Readme.md_autotoc_md3531}
...
See the \href{https://github.com/ChALkeR/safer-buffer/blob/master/Porting-Buffer.md}{\texttt{ porting guide}} for a better description.\hypertarget{Readme.md_autotoc_md3532}{}\doxysubsection{\texorpdfstring{Why not \href{https://npmjs.com/safe-buffer}{\texttt{ safe-\/buffer}}?}{Why not \href{https://npmjs.com/safe-buffer}{\texttt{ safe-\/buffer}}?}}\label{Readme.md_autotoc_md3532}
...
Also, {\ttfamily safer-\/buffer} discourages the usage of {\ttfamily .alloc\+Unsafe()}, which is often done by a mistake. It still supports it with an explicit concern barier, by placing it under `require(\textquotesingle{}safer-\/buffer/dangereous')\`{}.\hypertarget{Readme.md_autotoc_md3533}{}\doxysubsection{\texorpdfstring{But isn\textquotesingle{}t throwing bad?}{But isn\textquotesingle{}t throwing bad?}}\label{Readme.md_autotoc_md3533}
...
New commits, if tested, won\textquotesingle{}t land new usage of unsafe Buffer API this way. {\itshape Node.\+js 10.\+x also deals with that by printing a runtime depecation warning.}\hypertarget{Readme.md_autotoc_md3534}{}\doxysubsubsection{\texorpdfstring{Would it affect third-\/party modules?}{Would it affect third-\/party modules?}}\label{Readme.md_autotoc_md3534}
No, unless you explicitly do an awful thing like monkey-\/patching or overriding the built-\/in {\ttfamily Buffer}. Don\textquotesingle{}t do that.\hypertarget{Readme.md_autotoc_md3535}{}\doxysubsubsection{\texorpdfstring{But I don\textquotesingle{}t want throwing…}{But I don\textquotesingle{}t want throwing…}}\label{Readme.md_autotoc_md3535}
That is also fine!
