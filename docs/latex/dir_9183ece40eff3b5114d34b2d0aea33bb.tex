...
Create and parse HTTP {\ttfamily Content-\/\+Disposition} header\hypertarget{README.md_autotoc_md677}{}\doxysubsection{\texorpdfstring{Installation}{Installation}}\label{README.md_autotoc_md677}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ install\ content-\/disposition}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md678}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md678}

\begin{DoxyCode}{0}
\DoxyCodeLine{var\ contentDisposition\ =\ require('content-\/disposition')}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md679}{}\doxysubsubsection{\texorpdfstring{content\+Disposition(filename, options)}{content\+Disposition(filename, options)}}\label{README.md_autotoc_md679}
...
{\bfseries{note}} HTTP headers are of the ISO-\/8859-\/1 character set. If you are writing this header through a means different from {\ttfamily set\+Header} in Node.\+js, you\textquotesingle{}ll want to specify the `\textquotesingle{}binary'\`{} encoding in Node.\+js.\hypertarget{README.md_autotoc_md680}{}\doxysubsubsubsection{\texorpdfstring{Options}{Options}}\label{README.md_autotoc_md680}
{\ttfamily content\+Disposition} accepts these properties in the options object.\hypertarget{README.md_autotoc_md681}{}\doxysubsubsubsubsection{\texorpdfstring{fallback}{fallback}}\label{README.md_autotoc_md681}
...
If the {\ttfamily filename} option is ISO-\/8859-\/1 and this option is specified and has a different value, then the {\ttfamily filename} option is encoded in the extended field and this set as the fallback field, even though they are both ISO-\/8859-\/1.\hypertarget{README.md_autotoc_md682}{}\doxysubsubsubsubsection{\texorpdfstring{type}{type}}\label{README.md_autotoc_md682}
Specifies the disposition type, defaults to {\ttfamily "{}attachment"{}}. This can also be {\ttfamily "{}inline"{}}, or any other value (all values except inline are treated like {\ttfamily attachment}, but can convey additional information if both parties agree to it). The type is normalized to lower-\/case.\hypertarget{README.md_autotoc_md683}{}\doxysubsubsection{\texorpdfstring{content\+Disposition.\+parse(string)}{content\+Disposition.\+parse(string)}}\label{README.md_autotoc_md683}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md684}{}\doxysubsection{\texorpdfstring{Examples}{Examples}}\label{README.md_autotoc_md684}
\hypertarget{README.md_autotoc_md685}{}\doxysubsubsection{\texorpdfstring{Send a file for download}{Send a file for download}}\label{README.md_autotoc_md685}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md686}{}\doxysubsection{\texorpdfstring{Testing}{Testing}}\label{README.md_autotoc_md686}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$\ npm\ test}

\end{DoxyCode}
\hypertarget{README.md_autotoc_md687}{}\doxysubsection{\texorpdfstring{References}{References}}\label{README.md_autotoc_md687}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md688}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md688}
