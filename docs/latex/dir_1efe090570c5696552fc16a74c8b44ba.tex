...
Create HTTP errors for Express, Koa, Connect, etc. with ease.\hypertarget{README.md_autotoc_md1845}{}\doxysubsection{\texorpdfstring{Install}{Install}}\label{README.md_autotoc_md1845}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1846}{}\doxysubsection{\texorpdfstring{Example}{Example}}\label{README.md_autotoc_md1846}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md1847}{}\doxysubsection{\texorpdfstring{API}{API}}\label{README.md_autotoc_md1847}
This is the current API, currently extracted from Koa and subject to change.\hypertarget{README.md_autotoc_md1848}{}\doxysubsubsection{\texorpdfstring{Error Properties}{Error Properties}}\label{README.md_autotoc_md1848}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1849}{}\doxysubsubsection{\texorpdfstring{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}message\mbox{]}, \mbox{[}properties\mbox{]})}{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}message\mbox{]}, \mbox{[}properties\mbox{]})}}\label{README.md_autotoc_md1849}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1850}{}\doxysubsubsection{\texorpdfstring{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}error\mbox{]}, \mbox{[}properties\mbox{]})}{create\+Error(\mbox{[}status\mbox{]}, \mbox{[}error\mbox{]}, \mbox{[}properties\mbox{]})}}\label{README.md_autotoc_md1850}
...
\item {\ttfamily properties} -\/ custom properties to attach to the object
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1851}{}\doxysubsubsection{\texorpdfstring{create\+Error.\+is\+Http\+Error(val)}{create\+Error.\+is\+Http\+Error(val)}}\label{README.md_autotoc_md1851}
Determine if the provided {\ttfamily val} is an {\ttfamily Http\+Error}. This will return {\ttfamily true} if the error inherits from the {\ttfamily Http\+Error} constructor of this module or matches the "{}duck type"{} for an error this module creates. All outputs from the {\ttfamily create\+Error} factory will return {\ttfamily true} for this function, including if an non-\/{\ttfamily Http\+Error} was passed into the factory.\hypertarget{README.md_autotoc_md1852}{}\doxysubsubsection{\texorpdfstring{new create\+Error\mbox{[}code \texorpdfstring{$\vert$}{|}\texorpdfstring{$\vert$}{|} name\mbox{]}(\mbox{[}msg\mbox{]}))}{new create\+Error\mbox{[}code \texorpdfstring{$\vert$}{|}\texorpdfstring{$\vert$}{|} name\mbox{]}(\mbox{[}msg\mbox{]}))}}\label{README.md_autotoc_md1852}
Create a new error object with the given message {\ttfamily msg}. The error object inherits from {\ttfamily create\+Error.\+Http\+Error}.
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md1853}{}\doxysubsubsubsection{\texorpdfstring{List of all constructors}{List of all constructors}}\label{README.md_autotoc_md1853}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{README.md_autotoc_md1854}{}\doxysubsection{\texorpdfstring{License}{License}}\label{README.md_autotoc_md1854}
