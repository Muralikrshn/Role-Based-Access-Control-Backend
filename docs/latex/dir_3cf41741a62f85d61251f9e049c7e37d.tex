...
Brotli is supported in versions of node with a Brotli binding.\hypertarget{README.md_autotoc_md2441}{}\doxysubsection{\texorpdfstring{How does this differ from the streams in `require(\textquotesingle{}zlib')\`{}?}{How does this differ from the streams in `require(\textquotesingle{}zlib')\`{}?}}\label{README.md_autotoc_md2441}
...
See \href{http://npm.im/minipass}{\texttt{ Minipass}} for more on the differences between Node.\+js core streams and Minipass streams, and the convenience methods provided by that class.\hypertarget{README.md_autotoc_md2442}{}\doxysubsection{\texorpdfstring{Classes}{Classes}}\label{README.md_autotoc_md2442}
...
\end{DoxyItemize}\hypertarget{README.md_autotoc_md2443}{}\doxysubsection{\texorpdfstring{USAGE}{USAGE}}\label{README.md_autotoc_md2443}
...
\end{DoxyCode}
\hypertarget{README.md_autotoc_md2444}{}\doxysubsection{\texorpdfstring{REPRODUCIBLE BUILDS}{REPRODUCIBLE BUILDS}}\label{README.md_autotoc_md2444}
